<h1 class="home__title">Welcome to This Fake Blog</h1>
<script>
...
<a href="/articles" class="home__articlesLink">Articles</a>

<h3 class="home__subheading">Related Resources to the Exercise</h3>
<ul class="home__list">
  <a sveltekit:prefetch href="https://kit.svelte.dev/"><li class="home__list-item">Sveltekit</li></a>
